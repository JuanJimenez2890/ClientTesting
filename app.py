...
def description_card():
    ...
    return html.Div(
        id="description-card",
        children=[
            html.H5("SERVICE TRANSFORMATION TEST"),
            html.H2("Service Operational Model"),
...
def generate_control_card():
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Br(),
            html.Br(),
            html.P("Select Ticket Typification"),
            dcc.Dropdown(
                id="admit-select",
...
def generate_patient_volume_heatmap(start, end, clinic, hm_click, admit_type, reset):
    ...
    # Heatmap
    hovertemplate = "<b> %{y}  %{x} <br><br> %{z} Tickets Records"
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div(
            id="banner",
            className="banner",
            children=[html.Img(src=app.get_asset_url("plotly_logo2.png"))],
        ),
        # Left column
        html.Div(
            id="left-column",
        ...
        html.Div(
            ...
            children=[
                ...
                html.Div(
                    id="wait_time_card",
                    children=[
                        html.B("Client's Request Typification"),
                        html.Hr(),
